...
public class CodecTest {
	...
	// Keyphrase can be max 7 character (without duplicate chars) long - otherwise the checkerboard
	// does not have enough room for populating all the remaining characters in. Is there a test for
	// longer than 7 char keyphrase?
